...
> 💡 Note that the Google Play icon won't be generated by the Image Asset Studio, so it should be manually made by following the [official design specifications](https://developer.android.com/google-play/resources/icon-design-specifications).
